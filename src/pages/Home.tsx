...
import { ArrowDown, ArrowUpRight, ExternalLink, Github, Globe } from 'lucide-react'
...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-white relative">
      ...
      {/* Education Section */}
      <section id="education" className="py-16 md:py-32 px-8 bg-slate-50 relative">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="space-y-8">
              ...
              <p className="max-w-3xl text-lg font-light text-slate-600 leading-relaxed">
                {t('education.intro')}
              </p>
            </div>
              ...
              {educationItems.map((item, index) => (
                ...
                >
                  <div className="md:col-span-1 space-y-2">
                    <div className="text-sm font-light text-slate-400 uppercase tracking-wider">
                      {String(index + 1).padStart(2, '0')}
                    </div>
                    <h3 className="text-2xl md:text-3xl font-normal text-slate-900">{item.degree}</h3>
                    <p className="text-base font-light text-blue-600">{item.school}</p>
                  </div>
                  <div className="md:col-span-2 space-y-4">
                    <p className="text-lg font-normal text-slate-800">{item.field}</p>
                    <p className="text-base font-light text-slate-600 leading-relaxed">
                      {item.description}
                    </p>
                    <div className="flex items-center gap-3 pt-2">
                      ...
                      <span className="text-sm font-light text-slate-600">{item.status}</span>
                    </div>
                  </div>
                </motion.div>
              ))}
                ...
                >
                  <div className="md:col-span-1">
                    ...
                    <Link
                      ...
                      className="group inline-flex items-start gap-2 text-2xl md:text-3xl font-normal text-slate-900 hover:text-blue-600 transition-colors"
                    >
                      <span>{project.title}</span>
                      <ArrowUpRight className="h-5 w-5 mt-2 -translate-x-1 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 transition-all" />
                    </Link>
                  </div>
                  <div className="md:col-span-2 space-y-4">
                    <p className="text-base font-light text-slate-600 leading-relaxed">
                    ...
                    <div className="flex flex-wrap gap-3 pt-4">
                      <Link
                        to={`/projects/${project.slug}`}
                        className="inline-flex items-center gap-2 rounded border border-blue-600 px-4 py-2 text-sm font-light text-blue-600 transition-colors hover:bg-blue-600 hover:text-white"
                      >
