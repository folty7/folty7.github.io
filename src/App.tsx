    ...
    <div className="min-h-screen bg-slate-100 dark:bg-slate-900">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-200 dark:bg-slate-800">
        ...
        <div className="absolute top-0 left-0 right-0 z-20 px-8 py-6 flex justify-between items-center">
          ...
          <nav className="flex gap-8">
            <a
              ...
              className="text-sm text-slate hover:text-indigo-500 transition-colors cursor-pointer"
            >
              About
            </a>
            <a
        ...
        <div className="absolute top-1/4 right-12 z-20 text-right">
          ...
          >
            <ArrowDown className="w-6 text-indigo-500 ml-auto mb-4" />
            <div className="text-2xl md:text-3xl font-light text-slate">
              <div>Freelance</div>
              <div className="text-indigo-500">Front-end Developer</div>
            </div>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="space-y-12">
              <h2 className="text-6xl md:text-7xl font-light tracking-tight text-slate-900 dark:text-slate-100">
                Crafting modern web<br />experiences with <span className="text-indigo-600 dark:text-indigo-400">Vue.js</span>
              </h2>

              <div className="flex items-start gap-8 max-w-3xl">
                <div className="text-4xl font-light text-indigo-600 dark:text-indigo-400">→</div>
            ...
            <div className="space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl">
                <div className="space-y-3">
                  <div className="text-5xl font-light text-indigo-600 dark:text-indigo-400">10+</div>
                  <p className="text-base font-light text-slate-600 dark:text-slate-400">úspešne dodaných projektov rôznej komplexnosti</p>
                </div>
                <div className="space-y-3">
                  <div className="text-5xl font-light text-indigo-600 dark:text-indigo-400">4</div>
            ...
            {/* Aktuálne */}
            <div className="max-w-3xl border-l-2 border-indigo-600 dark:border-indigo-400 pl-8">
              <p className="text-lg font-light text-slate-600 dark:text-slate-300 leading-relaxed">
                <strong className="font-normal text-indigo-600 dark:text-indigo-400">Aktuálne:</strong> Hľadám príležitosti na internship alebo prácu na dohodu,
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <a
                      ...
                      className="text-lg font-light text-slate-900 dark:text-slate-100 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
                    >
                      foltadev@gmail.com
                    </a>
                  </div>
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <motion.a
                    ...
                    className="flex items-center gap-4 text-lg font-light text-slate-900 dark:text-slate-100 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors group"
                    whileHover={{ x: 5 }}
                  >
                    <svg className="w-5 h-5 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
